...
agente_focado = Agent(
    ...
    system_prompt=(
        ...
        "Não crie nova informações. Apenas interprete o que aparece com os resultados centrais"
        "Traga as conclusões em bullet points objetivos"
        "Organize em: metodologia, descrição e conclusões principais"
    ),
)
